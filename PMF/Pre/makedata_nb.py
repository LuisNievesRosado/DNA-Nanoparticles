...
if TYPE == 'AB':
    ...
    P1ST = [5, 3] # Particle 1 Short Polymer Interactive, Length equal NinterS
    P1LT = [3, 5, 4, 6] # Particle 1 Long Polymer Interactive, Length equal NinterL
    P2ST = [3, 5] # Particle 2 Short Polymer Interactive, Length equal NinterS
    P2LT = [5, 3, 6, 4] # Particle 2 Long Polymer Interactive, Length equal NinterL
    ...
    P1ST = [5, 3] # Particle 1 Short Polymer Interactive, Length equal NinterS
    P1LT = [3, 5, 4, 6] # Particle 1 Long Polymer Interactive, Length equal NinterL
    P2ST = [5, 3] # Particle 2 Short Polymer Interactive, Length equal NinterS
    P2LT = [3, 5, 4, 6] # Particle 2 Long Polymer Interactive, Length equal NinterL
    FlaT = 7 # Flanking Particle 
    Cor2 = 1 # Core Particle for Particle 2
elif TYPE == 'BB':
    Cor1 = 8 # Core Particle for Particle 1
    SpaT = 2 # Spacer Particle
    P1ST = [3, 5] # Particle 1 Short Polymer Interactive, Length equal NinterS
    P1LT = [5, 3, 6, 4] # Particle 1 Long Polymer Interactive, Length equal NinterL
    P2ST = [3, 5] # Particle 2 Short Polymer Interactive, Length equal NinterS
    P2LT = [5, 3, 6, 4] # Particle 2 Long Polymer Interactive, Length equal NinterL
    FlaT = 7 # Flanking Particle 
    Cor2 = 8 # Core Particle for Particle 2
